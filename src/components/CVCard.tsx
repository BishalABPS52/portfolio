  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full">
      ...
      <div className={`relative z-10 w-full flex flex-col items-center justify-center`}>
        <div className={`rounded-2xl shadow-xl max-w-2xl w-full p-8 bg-gradient-to-br from-teal-400/40 via-teal-200/30 to-blue-300/30 backdrop-blur-md ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
          <h1 className={`text-4xl font-moranga text-center mb-6 ${theme === 'dark' ? 'text-white' : 'text-teal-700'}`}>Curriculum Vitae</h1>
          <div className="prose max-w-none mx-auto">
            <h2 className="text-2xl font-bold mb-2" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Bishal Shrestha</h2>
            ...
            <hr className="my-4" />
            <h3 className="text-xl font-bold mb-1" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Profile</h3>
            <p>
            ...
            <hr className="my-4" />
            <h3 className="text-xl font-bold mb-1" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Experience</h3>
            ...
            <hr className="my-4" />
            <h3 className="text-xl font-bold mb-1" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Education</h3>
            <ul className="list-disc pl-5">
            ...
            <hr className="my-4" />
            <h3 className="text-xl font-bold mb-1" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Skills</h3>
            <ul className="list-disc pl-5">
            ...
            <hr className="my-4" />
            <h3 className="text-xl font-bold mb-1" style={{ color: theme === 'dark' ? '#fff' : '#780000' }}>Hobbies</h3>
            <ul className="list-disc pl-5">
