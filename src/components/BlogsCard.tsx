...
const blogPosts = [
  {
    ...
    description: "An in-depth look at the design decisions, technologies, and learning experiences while creating this portfolio website.",
  ...
  },
  {
    ...
    description: "My experiences, challenges, and growth as a computer engineering student at the Institute of Engineering, Thapathali Campus.",
      ...
      {blogPosts.map((post) => (
        ...
        >
          <Link href={post.href} className="block h-full">
            ...
            <div className="p-4">
              <h3 
                className="text-xl font-moranga mb-1 transition-colors duration-300 group-hover/card:text-[#c1121f]"
                style={{ color: theme === 'dark' ? '#c1121f' : '#780000' }}
              >
                {post.title}
              </h3>
              <p className="text-sm text-[var(--muted)] mb-2">{post.description}</p>
